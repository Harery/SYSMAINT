#!/usr/bin/env bash
# lib/progress.sh — Progress UI and adaptive timing system
# Provides: show_progress, start_status_panel, update_status_panel_phase, stop_status_panel
# Depends on: lib/utils.sh for timing functions
