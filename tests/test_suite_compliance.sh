...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(Security audit|results)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(sudoers|shadow|permissions)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(shadow|sudoers)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(shadow|sudoers|permissions)"; then
...
if echo "$output" | grep -qE "(DRY RUN|would)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(sudoers|Security audit)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(Security audit|permissions)"; then
...
if echo "$output" | grep -qE "(DRY_RUN:|would run|System maintenance|System maintenance started|checking|verify)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(Security|permissions|checking)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(shadow|security)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(sudoers|permissions)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --upgrade 2>&1 || true)
if echo "$output" | grep -qE "(upgrade|update|checking)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run 2>&1 || true)
if echo "$output" | grep -qE "(DRY_RUN:|would run|System maintenance|System maintenance started)"; then
...
output=$(DRY_RUN=true JSON_SUMMARY=false bash "$SYSMAINT" --dry-run --security-audit 2>&1 || true)
if echo "$output" | grep -qE "(checking|Security audit|verify)"; then
