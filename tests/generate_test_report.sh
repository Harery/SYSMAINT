...
TITLE="OCTALUM-PULSE Test Report"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --title TITLE    Report title (default: OCTALUM-PULSE Test Report)"
...
<head>
    ...
    <title>OCTALUM-PULSE Test Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🧪 OCTALUM-PULSE Test Report</h1>
...
cat >> "$OUTPUT_FILE" << HTMLEOF
        ...
        <div class="footer">
            <p>Generated by OCTALUM-PULSE Test Infrastructure</p>
